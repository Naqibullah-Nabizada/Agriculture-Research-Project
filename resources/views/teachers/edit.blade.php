...
@section('head-tag')
    <title>ویرایش نمودن استاد</title>
...
@section('content')
    <section>
        <div>
            <h5 class="text-center pt-2">ویرایش نمودن استاد<i class="fa fa-user mx-2"></i></h5>
            <hr>
            <form action="{{ route('teachers.update', $teacher->id) }}" method="POST" class="employees-form" id="researcher-form">
                @csrf
                @method('PUT')
                <div class="col-12 col-md-6 col-lg-4 my-1">
                    ...
                    <input type="text" name="firstname"
                        ...
                        value="{{ old('firstname', $teacher->firstname) }}" autofocus required>
                    @error('firstname')
                ...
                <div class="col-12 col-md-6 col-lg-4 my-1">
                    ...
                    <input type="text" name="lastname" class="form-control mb-2 @error('lastname') is-invalid @enderror"
                        placeholder="تخلص" value="{{ old('lastname', $teacher->lastname) }}" required>
                    @error('lastname')
                        <p class="text-danger my-2">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mx-auto my-2">
                    <button type="submit" class="btn btn-warning">ویرایش<i
                            class="fa fa-edit mx-1"></i></button>
