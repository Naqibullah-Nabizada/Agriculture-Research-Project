...
@section('head-tag')
    <title>ویرایش نمودن صنف جدید</title>
@endsection
    ...
    <section>
        ...
        <div class="d-flex mx-auto my-5">
            <div class="col-3 mx-auto mb-3">
                <h5 class="text-center pt-5 pb-3">ویرایش نمودن صنف</h5>
                <hr>
                <form action="{{ route('classes.update', $class->id) }}" method="POST">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" class="form-control mb-3" placeholder="نام صنف"
